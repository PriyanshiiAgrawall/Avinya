        ...
        <div className={styles.videoSection}>
            ...
            <div className={styles.patientControls}>
              <div className={styles.joinForm}>
                ...
                <input
                  type="text"
                  id="roomIdInput"
                  placeholder="Enter Room ID provided by your doctor"
                />
          ...
          {currentRole === "patient" && isPrescriptionApproved && (
            <div className={styles.prescriptionSection}>
              ...
              <div className={styles.prescriptionContent}>{consultationText}</div>
              <div className={styles.prescriptionActions}>
                <button className={styles.roleButton} onClick={downloadPrescription}>
